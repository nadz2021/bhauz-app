          ...
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-4-desktop mdc-layout-grid__cell--span-6-tablet">
                <div class="mdc-card">
                <form class="user" action="" method="post" name="authentication">
                    <div class="mdc-layout-grid">
                      <div class="mdc-layout-grid__inner">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <button type="submit" name="login" href="../../index.html" class="mdc-button mdc-button--raised w-100">
                            Login
                          </button>                          
                        </div>
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                            <h4 class="text-danger mx-auto"><strong><?php echo $error_msg; ?></strong></h4>                          
                        </div>
                      </div>
                    </div>
                  </form>
